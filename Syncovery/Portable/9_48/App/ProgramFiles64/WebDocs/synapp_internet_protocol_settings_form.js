...
function ApplyInternetSettings(ignoreerrors)
{
   ...
   if (GLeftOrRight == "left")
   {
      ...
      GLeftProtocolName = $("#jqxProtocolCombo").jqxDropDownList('val');
      GProtocolName = GLeftProtocolName;
   ...
   {
      //in synapp_profile_editor_form
      GRightProtocolName = $("#jqxProtocolCombo").jqxDropDownList('val');
      GProtocolName = GRightProtocolName;
