...
%cd%\EnvPathALL\EnvPathALL.exe %cd%\AppCloud\ALL.envpathall

%cd%\EnvPath\EnvPath.exe %cd%\CloudApp\ALL.envpath
%cd%\EnvPathALL\EnvPathALL.exe %cd%\CloudApp\ALL.envpathall
...
%cd%\AppALL\AppALL.exe %cd%\CmdApp\ALL.appall
