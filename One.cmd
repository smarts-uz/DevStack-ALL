...
START /min %cd%\AppHost\AppHost.exe
START /min %cd%\AppLink\AppLink.exe
START /min %cd%\AppLNK\AppLNK.exe
START /min %cd%\AppMany\AppMany.exe
START /min %cd%\AppProt\AppProt.exe
START /min %cd%\AppServ\AppServ.exe
START /min %cd%\AppShell\AppShell.exe
START /min %cd%\AutoRun\AutoRun.exe

START /min %cd%\EnvPath\EnvPath.exe
